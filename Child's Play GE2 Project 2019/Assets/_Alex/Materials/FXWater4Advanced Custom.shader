...
// Modification by Alex Lepage, 14 November 2018, Allow Underwater through view
Shader "Custom/Water4 Custom" {
Properties {
	//ADDED by Alex L. 14 November 2018 Allow Underwater through view
	[Toggle] _UWThroughView("Underwater Through View", float) = 0
...
CGINCLUDE
	...
	half4 frag( v2f i ) : SV_Target
	{
		...
		//ADDED by Alex L. 14 November 2018 Allow Underwater through view
		if (viewVector.y > 0 && _UWThroughView == 1) { viewVector = -viewVector; }
